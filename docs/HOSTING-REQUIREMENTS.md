...
- PHP: 8.2 hoặc 8.3.
- Database: MySQL 8.0+, gồm hai database dùng chung một tài khoản MySQL:
...
- Cho phép ít nhất 2 database MySQL và một user có quyền trên cả hai database.
...
- `oufeidun_app` đã có 19 bảng khung dữ liệu; dung lượng ban đầu dưới 1 MB.
